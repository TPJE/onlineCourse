...
export default {
  ...
  // Use watch to monitor router
  watch: {
    $route: {
        handler: function(val, oldVal) {
            // Activate sidebar
            console.log("----> Redirect to page: ", val, oldVal);
            let _this = this;
  ...
  methods: {
    ...
    /**
     * Sidebar menu focus style (fold or open), id is the selected (onClick) sidebar element's id.
     * @param id
     */
    activeSidebar: function (id) {
      ...
      // Remove "open active" from parent and parent's li (if applicable) and set selected parent to "open active"
